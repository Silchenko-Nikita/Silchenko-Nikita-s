...
#   define TwEventMouseWheelGLFW  TwEventMouseWheelGLFWcdecl
    TW_API int TW_CDECL_CALL TwEventMouseButtonGLFW3cdecl(int glfwButton, int glfwAction);
    TW_API int TW_CDECL_CALL TwEventKeyGLFW3cdecl(int glfwKey, int glfwAction);
    TW_API int TW_CDECL_CALL TwEventCharGLFW3cdecl(int glfwChar, int glfwAction);
    TW_API int TW_CDECL_CALL TwEventMousePosGLFW3cdecl(int mouseX, int mouseY);
    TW_API int TW_CDECL_CALL TwEventMouseWheelGLFW3cdecl(int wheelPos);
#   define TwEventMouseButtonGLFW3 TwEventMouseButtonGLFW3cdecl
#   define TwEventKeyGLFW3         TwEventKeyGLFW3cdecl
#   define TwEventCharGLFW3        TwEventCharGLFW3cdecl
#   define TwEventMousePosGLFW3    TwEventMousePosGLFW3cdecl
#   define TwEventMouseWheelGLFW3  TwEventMouseWheelGLFW3cdecl
#else
...
#   define TwEventMouseWheelGLFW   TwMouseWheel
    TW_API int  TW_CALL TwEventMouseButtonGLFW3(int glfwButton, int glfwAction);
    TW_API int  TW_CALL TwEventKeyGLFW3(int glfwKey, int glfwAction);
    TW_API int  TW_CALL TwEventCharGLFW3(int glfwChar, int glfwAction);
#   define TwEventMousePosGLFW3     TwMouseMotion
#   define TwEventMouseWheelGLFW3   TwMouseWheel
#endif
