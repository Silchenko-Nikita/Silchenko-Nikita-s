...
protected:
	...
	void addDoubleVar(const char * varName, double * var, bool isNonnegat, int minExp = -100, int maxExp = 100, bool ableToSetDefault = true, bool readOnly = false);
	void addVector3dVar(const char * varName, Vector3d * var, bool isNonnegat, int minExp = -100, int maxExp = 100, bool ableToSetDefault = true, bool readOnly = false);
	...
	void addDoubleVarToGroup(const char * groupName, const char * varName, double * var, bool isNonnegat, int minExp = -100, int maxExp = 100, bool ableToSetDefault = true, bool readOnly = false);
	void addColorVarToGroup(const char * groupName, const char * varName, Vector3f * var, bool ableToSetDefault = true);
	void addVector3dVarToGroup(const char * groupName, const char * varName, Vector3d * var, bool isNonnegat, int minExp = -100, int maxExp = 100, bool ableToSetDefault = true, bool readOnly = false);
	...
	Pane& operator=(Pane &) {};
public:
	void addSpaceObject(SpaceObject * spObj, bool ableToSetTextured = true, bool ableToSetDefault = true, bool ableToDelete = true, bool closed = true);
