...
protected:
	...
	SpaceObject * parent; // defines the meaning of objects accel, velocity and position (if they are relative to parent or absolute)

	bool _isInteracting;
	bool _isActive;
	bool _isVisible;
	bool _isBeingRendered;
	bool boundToParent; // if interacts with parent only (for providing easy way to control position)
...
public:
	...
	static double getDiamDisplayFactor() { return diamDisplayFactor; }
	static double getDistDisplayFactor() { return distDisplayFactor; }
